 ...
 * GET /api/notion/test-db?databaseId=...&after=today&editedAfter=2026-03-09T00:00:00Z
...
export async function GET(request: NextRequest) {
  ...
  const databaseId =
    searchParams.get("databaseId") ?? "18964a2b-0fe3-80c7-80d5-c3549fbb7c80";
  ...
  try {
    ...
    return NextResponse.json({
      ...
      rows,
      ...(afterDate && {
        filterApplied: { after: afterDate, dateProperty: datePropertyName ?? null },
      }),
    });
  } catch (err) {
